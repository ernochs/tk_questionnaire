...
<html lang="en">
  <head>
    ...
    <title>T.K QUESTIONNAIRE DASHBOARD</title>
    ...
    <div class="container-scroller">
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="admin/post_question.php">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./pages/forms/template/assets/css/documentation/documentation.html">
